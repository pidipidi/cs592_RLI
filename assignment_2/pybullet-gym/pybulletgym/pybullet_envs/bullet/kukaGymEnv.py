...
class KukaGymEnv(gym.Env):
  ...
  def __init__(self,
    ...
    # --------------------------------------------------------------
    # Place your code here! (Define your action space)
    # --------------------------------------------------------------   
    if (self._isDiscrete):
  ...
  def getExtendedObservation(self):
    ...
    # You can return the relative x,y position and anguler displacement of block from the gripper
    # If you need, you can scale the observation for better learning
    ...
    # Place your observation in the container. You can use any size of list
  ...
  def _reward(self):
    ...
    # Add a reward as you want (sparse reward will work)
    #if (blockPos[2] > 0):
